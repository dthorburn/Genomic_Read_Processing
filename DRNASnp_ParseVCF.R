...
if(Mode == "DNAseq"){
	...
	fwrite(file = paste0("./06_SelectVariants/", fil_name, "_Annotation_Distribution.csv"), output)
} else if(Mode == "RNAseq"){
	ggsave(file = paste0("./07_MergedVCFs/", fil_name, "_Annotation_Distribution.png"), height = 300, width = 400, units = "mm")
	fwrite(file = paste0("./07_MergedVCFs/", fil_name, "_Annotation_Distribution.csv"), output)
}
